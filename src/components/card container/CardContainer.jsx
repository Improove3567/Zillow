...
import EmptyCart from "../../components/images/emptyCart.svg"
        ...
        <motion.div
            ...
            <div className='w-full flex items-center justify-between p-4 cursor-pointer'>
                ...
                <motion.p whileTap={{ scale: 0.75 }} className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 
                    rounded-md hover:shadow-md cursor-pointer tetxt-textColor text-base'
            ...
            {cartItems && cartItems.length > 0 ? (
                ...
                justify-evenly px-8 py-2'>
                        ...
                        <div className='w-full flex items-center justify-between'>
                            ...
                            <p className='text-gray-200 text-xl font-semibold'>$ {tot + 2.25}</p>
                        </div>
